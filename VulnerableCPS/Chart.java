...
public class Chart extends ApplicationFrame{
	static String title;
	static int total, normal, strict, stealthy;
public Chart(String paramString,int t, int n, int s, int st){
	super(paramString);
	total = t;
	normal = n;
	strict = s;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(total,"Total Sent","Total Sent");
	localDefaultCategoryDataset.addValue(normal,"Normal Detected","Normal Detected");
	localDefaultCategoryDataset.addValue(strict,"Strict-Stealthy","Strict-Stealthy");
	localDefaultCategoryDataset.addValue(stealthy,"Stealthy","Stealthy");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Different Eigen Packets Detected", "Packets Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
